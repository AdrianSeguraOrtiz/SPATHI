        ...
        for record in records:
            ...
            self._model_diagnostics_writer.writerow(
                (
                    ...
                    record.tree_nodes_total,
                    record.tree_nodes_mean,
                    record.tree_nodes_p50,
                    record.tree_nodes_p95,
                    record.tree_nodes_max,
                    record.tree_leaves_total,
                    record.tree_leaves_mean,
                    record.tree_leaves_p50,
                    record.tree_leaves_p95,
                    record.tree_leaves_max,
                    record.tree_depth_total,
                    record.tree_depth_mean,
                    record.tree_depth_p50,
                    record.tree_depth_p95,
                    record.tree_depth_max,
                    record.message,
                )
            )
            count += 1
