...
class InteractiveReportBuilder:
    ...
    def add_target(self, weights: WeightResult, diagnostics: WeightDiagnostics) -> None:
        ...
        self._target_metrics[target_index] = {
            ...
            "raw_positive_cell_count": diagnostics.raw_positive_cell_count,
            "positive_cell_count": diagnostics.positive_cell_count,
            "canonicalized_cell_count": diagnostics.canonicalized_cell_count,
            "canonicalized_weight_mass": diagnostics.canonicalized_weight_mass,
            "canonicalization_threshold": diagnostics.canonicalization_threshold,
